...
import { Shield, ArrowRight, UserPlus, Fingerprint } from 'lucide-react';
...
export default function SignupPage() {
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        try {
            // 1. Generate unique salt for this user (for client-side encryption)
        ...
        <div className="min-h-screen bg-[#0a0a0a] text-white flex items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="w-full max-w-md relative z-10">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-3xl font-bold mb-2">Begin Your Legacy</h1>
                    <p className="text-gray-400">Secure your assets for the next generation</p>
                </div>
                ...
                <div className="bg-white/[0.03] border border-white/10 p-8 rounded-3xl backdrop-blur-xl shadow-2xl">
                    ...
                    <form className="space-y-6" onSubmit={handleSignup}>
                        ...
                        >
                            {loading ? 'Securing...' : 'Initialize Vault'}
                    ...
                    <p className="text-center mt-8 text-sm text-gray-400">
                        ...
                        <Link href="/login" className="text-emerald-500 hover:underline font-semibold transition-colors">
                            Sign In
                        </Link>
                    </p>
                </div>
